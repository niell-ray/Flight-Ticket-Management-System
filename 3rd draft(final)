...
public class FlightTicketManagementSystem extends Frame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // Handle done button click event in ticket dialog
            ...
            String departurePlace = nameField.getText();
            String departureTime = dobField.getText();
            String arrivalPlace = genderField.getText();
            String arrivalTime = phoneField.getText();
            String airlineName = ticketDialog.getTitle();

            // Display ticket details
            String details = "Customer Name: " + departurePlace
                            + "\nDate of Birth: " + departureTime
                            + "\nGender: " + arrivalPlace
                            + "\nPhone Number: " + arrivalTime
                            + "\nDeparture Place: " + airlineName
    ...
    private void showTicketDialog() {
        ...
        ticketDialog.setLayout(new GridLayout(6, 2));
        ticketDialog.add(new Label("Departure Place:"));
        TextField departurePlaceField = new TextField(20);
        ticketDialog.add(departurePlaceField);
        ticketDialog.add(new Label("Departure Time:"));
        TextField departureTimeField = new TextField(20);
        ticketDialog.add(departureTimeField);
        ticketDialog.add(new Label("Arrival Place:"));
        TextField arrivalPlaceField = new TextField(20);
        ticketDialog.add(arrivalPlaceField);
        ticketDialog.add(new Label("Arrival Time:"));
        TextField arrivalTimeField = new TextField(20);
        ticketDialog.add(arrivalTimeField);
        ticketDialog.add(new Label("Airline Name:"));
        TextField airlineNameField = new TextField(20);
        ticketDialog.add(airlineNameField);
